...
function Footer() {
    return (
        <div className='flex items-start justify-between gap-5 w-full h-screen bg-zinc-900 px-16 pt-16 pb-10'>

            <div className='w-1/2 h-full flex flex-col justify-between'>

                <div className='heading'>
                    <h1 className='font-founder text-zinc-100 uppercase text-[140px] leading-none'>eye-</h1>
                    <h1 className='font-founder text-zinc-100 uppercase text-[140px] leading-none'>opening</h1>
                </div>

                <div className='footer-logo'>
                    <svg width="72" height="30" viewBox="0 0 72 30" fill="white" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className='w-1/2 h-full flex flex-col justify-between'>
                ...
                <div className='div'>
                    ...
                    <div className='heading-right'>
                        <h1 className='font-founder text-zinc-100 uppercase text-[140px] leading-none'>presentations
                        </h1>
                    </div>

                    <div className='links font-montreal text-[18px]'>

                        <div className='social-container mb-7'>
                            <p className='head mb-5'>S:</p>
                ...
                <div>
                    <p className='text-[#7c7c7c] text-[18px] uppercase'>© ochi design 2024. Legal Terms</p>
                </div>
